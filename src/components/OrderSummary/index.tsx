          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-6 space-y-4 border-b border-t border-gray-200 py-8 dark:border-gray-700 sm:mt-8">
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white">
                Información sobre facturación y entrega
              </h4>
              <dl>
                ...
                <dd className="mt-1 text-base font-normal text-gray-500 dark:text-gray-400">
                  Bonnie Green - +1 234 567 890, Santiago de Chile, Chile, 3454,
                  Scott Street
                </dd>
              </dl>
              <button
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          >
                            <img
                              ...
                              src="https://www.elmejornido.com/sites/g/files/jgfbjl316/files/styles/facebook_share/public/recipe-thumbnail/116753-cc72869fabfc2bdfa036fd1fe0e2bad8_creamy_alfredo_pasta_long_left.jpg?itok=vtPFA3DF"
                              alt="imac image"
                            />
                          </a>
              ...
              <div className="mt-4 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <dl className="flex items-center justify-between gap-4">
                      <dt className="text-gray-500 dark:text-gray-400">Impuesto</dt>
                      <dd className="text-base font-medium text-gray-900 dark:text-white">
                        $799
                      </dd>
                    </dl>
